...
>
> I'll help you build your professional profile so Gemini Agent can evaluate job postings, tailor CVs, write cover letters, and prepare you for interviews.
>
...
- `.Gemini Agent/skills/job-application-assistant/01-candidate-profile.md`
- `.Gemini Agent/skills/job-application-assistant/02-behavioral-profile.md`
- `.Gemini Agent/skills/job-application-assistant/03-writing-style.md`
- `.Gemini Agent/skills/job-application-assistant/04-job-evaluation.md`
- `.Gemini Agent/skills/job-application-assistant/05-cv-templates.md`
- `.Gemini Agent/skills/job-application-assistant/06-cover-letter-templates.md`
- `.Gemini Agent/skills/job-application-assistant/07-interview-prep.md`
...
Then proceed to Step 3 to populate the non-skill files (`Gemini Agent.md`, `cv/main_example.tex`, `.Gemini Agent/skills/job-scraper/search-queries.md`). Step 3 will detect that the seven skill files are already populated and skip those substeps.
...
### 8. Generate `.Gemini Agent/skills/job-scraper/search-queries.md`
...
>
> - `Gemini Agent.md` - Your full candidate profile
> - `.Gemini Agent/skills/job-application-assistant/01-candidate-profile.md` - Structured profile
> - `.Gemini Agent/skills/job-application-assistant/02-behavioral-profile.md` - Behavioral assessment
> - `.Gemini Agent/skills/job-application-assistant/04-job-evaluation.md` - Personalized evaluation framework
> - `.Gemini Agent/skills/job-application-assistant/05-cv-templates.md` - CV templates with your profile statements
> - `.Gemini Agent/skills/job-application-assistant/07-interview-prep.md` - STAR examples from your experience
> - `cv/main_example.tex` - Your LaTeX CV template
> - `.Gemini Agent/skills/job-scraper/search-queries.md` - Job search queries for `/scrape`
>
> **Try it out:**
